    ...
    <div class="container-fluid"> 
        ...
        <div class="row align-items-center justify-content-center m-0" id="heroarea">
            <div class="col-md-8 col-sm-10">
                <h1 class="mt-5 mb-3">Barangay Sta. Cruz Viejo</h1>
                <p class="pt-3 pb-2">Barangay Sta. Cruz Viejo is a continuously growing barangay that has more than one thousand residents. </p>
        ...
        <div class="row m-0 justify-content-center py-5" id="announcements">
            ...
            <div class="col-lg-10 col-md-11">
                <div class="row" id="announcements-container">
                    <?php
                    $qry = "SELECT * FROM announcement_post ORDER BY post_id DESC LIMIT 3";
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card announcement-card h-100">
                            <?php if(!empty($row['post_image'])): ?>
                                <img src="<?php echo htmlspecialchars($row['post_image']); ?>" class="card-img-top" alt="Announcement Image" style="height: 200px; object-fit: cover;">
                            <?php endif; ?>
                            ...
                            <div class="card-body">
                                ...
                                <small class="text-muted">Posted on: <?php echo $row['post_date_time']; ?></small>
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="text-center mt-4">
                    <a href="user_Announcements.php" class="btn btn-danger">View All Announcements</a>
                </div>
            </div>
        </div>
        ...
        <div class="row m-0">
            <div class="col-12 text-center text-muted">
                <p class="m-0 pb-3 mt-md-2 mt-sm-2">Brgy. Sta. Cruz Viejo, Copyright ©️ 2020 </p>
            </div>
        </div>
