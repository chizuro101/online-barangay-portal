...
$pageTitle = 'Announcements - Resident Portal';
     ...
     style="width: 80px; height: auto; background: transparent; mix-blend-mode: multiply;">
                    ...
                    <div class="row justify-content-around pb-4 mb-2 add-container">
                        ...
                        <div class="col-md-4 mt-2 mb-2 ">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Search Your Posts" id="search_announcement_field" name="search_announcement_field">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="posts-container" id="card_container">
                                ...
                                <?php
                                    $qry = "SELECT * FROM announcement_post WHERE (author_id = :resident_id AND author_type = 'resident') OR author_type IS NULL ORDER BY post_id DESC";
                                ...
                                <div class="card pb-2  mt-5 ml-3 mr-3 post-card" >
                                    ...
                                    <div class="card-header post-header"> 
                                        <div class="row">
                                            ...
                                            <div class="col text-left">
                                                ...
                                                <?php if($rowUser['author_type'] == 'resident'): ?>
                                                    <small class="text-muted ml-2">(Your Post)</small>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php if(!empty($rowUser['post_image'])): ?>
                                            <div class="post-image mb-3">
                                                <img src="<?php echo htmlspecialchars($rowUser['post_image']); ?>" class="img-fluid rounded" alt="Announcement Image" style="max-height: 300px; width: auto;">
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title create-post-heading" id="create-post-heading">Create New Announcement</h5>
                                ...
                                <div class="modal-body">
                                    <form action="admin_Actions.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-12 form-group ">
                                                <label for="post_image_field" class="create-post-form-label" >Announcement Image (Optional)</label>
                                                <input type="file" class="form-control create-post-form-field" id="post_image_field" name="post_image_field" accept="image/*">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col text-right mt-2 mb-2">
                                                <button type="submit" class="btn btn-danger create-post-btn" id="btn_resident_create_post" name="btn_resident_create_post">Publish Post</button>                                   
                                            </div>
                    ...
                    <div class="modal fade" id="edit-post-modal" tabindex="-1" role="dialog" aria-labelledby="edit-post-modal" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title edit-post-heading" id="edit-post-heading">Edit Your Announcement</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                ...
                                <div class="modal-body">
                                    <form action="admin_Actions.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-12 form-group ">
                                                <label for="edit_post_image_field" class="edit-post-form-label" >Update Announcement Image (Optional)</label>
                                                <input type="file" class="form-control edit-post-form-field" id="edit_post_image_field" name="edit_post_image_field" accept="image/*">
                                        ...
                                        <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-6 form-group text-center">
                                                ...
                                                <div class="input-group date" id="editdatetimepicker">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col text-right mt-2 mb-2">
                                                <button type="submit" class="btn btn-danger edit-post-btn" id="btn_resident_edit_post" name="btn_resident_edit_post">Update Post</button>                                   
                                            </div>
                                            <div class="col text-left mt-2 mb-2">
                    ...
                    <div class="modal fade" id="delete-post-modal" tabindex="-1" role="dialog" aria-labelledby="delete-post-modal" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title delete-post-heading" id="delete-post-heading">Delete Your Announcement</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                    ...
                                    <form action="admin_Actions.php" method="post">
                                        ...
                                        <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-6 form-group text-center">
                                                ...
                                                <div class="input-group date" id="deletedatetimepicker">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col text-right mt-2 mb-2">
                                                <button type="submit" class="btn btn-danger delete-post-btn" id="btn_resident_delete_post" name="btn_resident_delete_post">Delete Post</button>                                   
                                            </div>
                                            <div class="col text-left mt-2 mb-2">
        ...
        function load_date_picker_to_modal()
        {
            ...
            $('#edit-post-modal').on('show.bs.modal', function (e) {
                edit_date_time_picker_defaults(); 
                open_edit_date_picker();
            });
        }
        ...
        function edit_date_time_picker_defaults()
        {
            $.extend(true, $.fn.datetimepicker.defaults, {
                icons: {
                    time: 'far fa-clock',
        ...
        function open_edit_date_picker()
        {
        ...
        function load_post_to_edit_modal()
        {
            $('#edit-post-modal').on('show.bs.modal', function (e) {
                ...
                $.ajax({
                    type : 'post',
                    url : 'admin_Actions.php',
                    data : {resident_edit_load_post_info:post_id},
                    dataType: 'json',
                    success : function(data)
                    {
        ...
        function load_post_to_delete_modal()
        {
            $('#delete-post-modal').on('show.bs.modal', function (e) {
                ...
                $.ajax({
                    type : 'post',
                    url : 'admin_Actions.php',
                    data : {resident_delete_load_post_info:post_id},
                    dataType: 'json',
                    success : function(data)
                    {
